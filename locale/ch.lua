...
-- Written: Sunday, 24 March 2013 at 15:15:36
...
-- /cygdrive/c/source/mushclient/sendvw.cpp:376

-- /cygdrive/c/source/mushclient/sendvw.cpp:2296
  ["Spell check ..."] =
    "拼写检查",
...
-- /cygdrive/c/source/mushclient/sendvw.cpp:2356
  ["Notepad: %s"] =
    function (a)
...
-- /cygdrive/c/source/mushclient/dialogs/world_prefs/triggdlg.cpp:200
  ["The trigger 'match' text contains an invalid non-printable character (hex %02X) at position %i."] =
    function (a, b)
      ...
      return "触发器 “内容”的文本中包含无效的非打印字符("..a..") 位置"..b
    end,  -- function
...
-- /cygdrive/c/source/mushclient/dialogs/world_prefs/triggdlg.cpp:214
  ["The trigger 'send' text contains an invalid non-printable character (hex %02X) at position %i."] =
    function (a, b)
      ...
      return "触发器 “发送”的文本中包含无效的非打印字符("..a..") 位置"..b
    end,  -- function
...
-- /cygdrive/c/source/mushclient/doc.cpp:775
  ["Welcome to MUSHclient version %s!"] =
    function (a)
      ...
      return "欢迎使用 MUSHclient 北大侠客行专用版 版本 " .. a .. "！"
    end,  -- function
...
-- /cygdrive/c/source/mushclient/sendvw.cpp:1031
...
-- /cygdrive/c/source/mushclient/sendvw.cpp:1045
  ["Quit from %s?"] =
    function (a)
...
-- /cygdrive/c/source/mushclient/sendvw.cpp:1353
...
-- /cygdrive/c/source/mushclient/sendvw.cpp:2177
...
-- /cygdrive/c/source/mushclient/sendvw.cpp:2588
  ["Accelerator: %s"] =
    function (a)
...
-- /cygdrive/c/source/mushclient/worldsock.cpp:158
  ["--- Matched %i trigger%s, %i alias%s, and %i timer%s fired."] =
    function (a, b, c, d, e, f)
      ...
      return "--- 匹配了"..a.."个触发器"..b..","..c.."个别名"..d..", 触发了"..e.."次计时器"..f
    end,  -- function
